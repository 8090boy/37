...
(this, function() {
    var t = function(t, a, e, n, i, r) {
        for (var o = 0, s = ["webkit", "moz", "ms", "o"], u = 0; u < s.length && !window.requestAnimationFrame; ++u) {
        ...
        for (var m in r) {
            r.hasOwnProperty(m) && (this.options[m] = r[m])
        }
        ...
        this.duration = 1000 * Number(i) || 2000;
        var l = this;
...
function BuildConfirmDiv() {
    var strConfirm = '<div id="ConfirmDiv">    <div id="confirmMessageDiv">Hi,Would you help me,please?</div>    <div class="message_button">    <input id="confirmOKButton" type="button" name="btnOk" value="OK">    <input id="confirmCancelButton" type="button" name="btnOk" value="Cancel">    </div>    </div>    <div id="maskConfirm" class="maskConfirm"></div>';
...
window.confirm = function(message, okCallBack, cancelCallBack) {
    ...
    document.getElementById("maskConfirm").style.display = "block";
    document.getElementById("confirmMessageDiv").innerHTML = message;
    var confirmCancelButton = document.getElementById("confirmCancelButton");
    confirmCancelButton.onclick = function() {
        document.getElementById("ConfirmDiv").style.display = "none";
        if (cancelCallBack != null  && cancelCallBack != "") {
            document.getElementById("maskConfirm").style.display = "none";
            eval(cancelCallBack)
        }
    }
    ;
